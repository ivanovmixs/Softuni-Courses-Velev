...
VALUES
    ...
    ('17', 'Plaza Mayor', 'Centro', 'Madrid', 'Madris', 'Spain', 'Europe', true),
    ('3', 'Plaza San Marco', 'San Marco', 'Venice', 'Veneto', 'Italy', 'Europe', false),
	...
	('27', 'Koningsplein', 'Centrum', 'Amsterdam', 'North Holand', 'Netherlands', 'Europe', true),
